...
export const FontProvider: React.FC<FontProviderProps> = ({ children }) => {
    const h1 = useFont(require('@/assets/fonts/general-sans/GeneralSans-Medium.otf'), 26);
    const h2 = useFont(require('@/assets/fonts/general-sans/GeneralSans-Medium.otf'), 22);

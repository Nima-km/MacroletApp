...
const logs = () => {
	...
	return (
		<KeyboardAware>
			<HeaderSimple title="LOGS" dateSelector back={false} />
			<ScrollView>
				<View
					style={{
				...
				>
					...
					<MyBarChart
						goal={{
							...
							protein: nutriGoals?.[0]?.protein ?? 0,
							carbs: nutriGoals?.[0]?.carbs ?? 0,
							fat: nutriGoals?.[0]?.fat ?? 0,
						}}
						progress={LiveFood?.[0]}
					/>
					<View
					...
					<View style={{ paddingHorizontal: 20 }}>
						{slData.length == 0 && (
							...
							>
								...
								>
									<H4 style={[{ color: colors.inactive }]}>
										No meals logged yet.
									</H4>
									<H4
										style={[

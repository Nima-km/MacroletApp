...
export const CalculateMacroSumIngredient = (
    ...
    const macros = ingredientItemsData.map((item) => {
        return {
            protein:
                item.food.protein *
                item.ingredientItem.serving_mult *
                item.ingredientItem.servings,
            carbs:
                item.food.carbs *
                item.ingredientItem.serving_mult *
                item.ingredientItem.servings,
...
export const CalculateMacroSum = (foodItemsData?: Array<FoodFullData>) => {
    ...
    const macros = foodItemsData.map((item) => {
        return {
            protein:
                item.food.protein *
                item.foodItem.serving_mult *
                item.foodItem.servings,
            carbs:
                item.food.carbs *
                item.foodItem.serving_mult *
                item.foodItem.servings,
